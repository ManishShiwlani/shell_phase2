...
//phase2-Advanced Systems Programming
...
/**
 * $ substitution of environment variables - not required for phase2
...
/**
 * exit requirement of the project
...
/**
 * change directory requirement of the project.
 * run "cd" command
 * cd command can only take 0 or 1 argument. cd with more than 1 will cause an error message
...
/**
 * setenv requirement of the project
 * run "set" command
